...
*Generated: 2026-07-03 | Source: SALES Jira Board (ID 10) | Most recently completed sprint as of report date (Sales 6/25 - 7/8 is active)*
...
Two SELLTECH tickets were updated during the sprint window with Salesforce relevance:
- **SELLTECH-966** — AddressController.AddressControllerException in Class.AddressController:337 (Done, updated 2026-06-24)
- **SELLTECH-578** — ICU Locale not enabled due to the API version below 45 used in the org[Managed Packages] (Won't Do, updated 2026-06-11)

Three PT project tickets were updated during the sprint window with Salesforce relevance:
- **PT-832** — My Closet Foundation (In Progress)
